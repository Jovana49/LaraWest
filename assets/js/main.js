...
postaviAtribute(dugme, {"type" : "button", "data-toggle" : "collapse", "data-target" : "navition-menu", "aria-controls" : "navition-menu", "aria-expanded" : "false", "aria-label" : "Toggle navigation"});
...
if (window.location.pathname == "o-nama.html" || window.location.pathname == "usluge.html" || window.location.pathname == "galrija.html" || window.location.pathname == "kontakts.html")
...
function formCheck() {
	...
	var gender = document.querySelectorAll('#formGender > input');
...
function ispisNaslova() {
  if (i < tekst.length) {
    document.querySelector("h1").innerHTML += tekst.charAt(i);
    i++;
